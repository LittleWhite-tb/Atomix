...
#ifndef BOARDTILESETTER_HPP
#define BOARDTILESETTER_HPP
...
{
private:
    static void setTile(Board& board, const UVec2& position, int tileID);
    
    friend Level::Level(ResourceBank* pResourceBank,const std::string& name);
};
